...
<script type="text/javascript">
    function exportFile() {
        ...
        var template = "UsernameReport";
        var fileType = "xlsx";//"pdf";
        ...
        if (username != null && username != "") {
            ...
            window.open("/servlet-app-day2/export?template="+template+"&fileType="+fileType+"&username="+username);
            ...
            // TIP: Remember that the application context it's named servlet-app
            window.open("/servlet-app-day2/export?template="+template+"&fileType="+fileType);
