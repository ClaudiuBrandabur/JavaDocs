...
public class Student {
    ...
    public String toString() {
        return "Studentul cu id-ul "+id+", are numele "+lastName+", prenumele "+firstName+" si media "+averageGrade;
    }
    ...
    public boolean equals(Object o) {
        ...
        if ( id.equals(stud.getId()) && lastName.equals(stud.getLastName()) &&
                firstName.equals(stud.getFirstName()) && averageGrade.equals(stud.getAverageGrade()) )
            return true;
        return false;
